        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="p-6 sm:p-8 rounded-2xl border border-border/60 bg-card/80 backdrop-blur-xl shadow-xl hover:border-primary/30 transition-all">
              <Suspense fallback={<div className="text-center py-8 text-sm text-muted-foreground"><Loader2 className="h-6 w-6 animate-spin mx-auto mb-2" />Loading signup form...</div>}>
                <SignupForm />
              </Suspense>
            </div>
