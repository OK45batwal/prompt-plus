...
import { POST as analyzeRoute } from "../app/api/v2/analyze/route";
import { POST as optimizeRoute } from "../app/api/v2/optimize/route";
...
describe("API v2 Endpoints", () => {
  const dummyAuthHeaders = {
    ...
    "x-promptplus-api-key": "pp_live_dummykey",
  };
