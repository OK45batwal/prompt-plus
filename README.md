...
```mermaid
flowchart LR
    A[Raw Input Idea] --> B[1. Intent & Domain Analysis]
    B --> C[2. Gap & Context Detection]
    C --> D[3. Meta-Prompt Compilation]
    D --> E[4. LLM Dispatch Engine]
    E --> F[5. Architectural Rewrite]
    F --> G[6. 6-Metric Quality Audit]
    G --> H[7. Version History Index]
    H --> I[8. One-Click Export / Insertion]
```
