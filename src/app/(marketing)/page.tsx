...
const steps = [
  { step: "01", title: "Write", description: "Enter your prompt idea in plain language." },
  { step: "02", title: "Analyze", description: "AI analyzes intent, category, and identifies improvements." },
  { step: "03", title: "Enhance", description: "Get a production-ready, optimized prompt." },
  { step: "04", title: "Use", description: "Copy, save, or export to any AI model." },
];
  ...
  return (
    <>
      ...
      <section className="py-20 px-4 border-t">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 animate-slide-up">
            ...
            <p className="text-muted-foreground mt-2">Four steps to a perfect prompt.</p>
          </div>
      ...
      <section className="py-20 px-4 border-t">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 animate-slide-up">
            ...
            <p className="text-muted-foreground mt-2">Everything you need to craft the perfect prompt.</p>
          </div>
      ...
      <section className="py-20 px-4 border-t animate-slide-up">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-semibold tracking-tight">Ready to write better prompts?</h2>
